    ...
    $(function() {
        $.fn.tinylogo = function(options) {
            ...
            $(options.button).click(function() {  
                ...
                tb_show('Upload a logo', 'media-upload.php?referer=tinylogo&type=image&TB_iframe=true&post_id=0', false);
        ...
        // Usage
        $('.button').tinylogo(); // Use as default option.
